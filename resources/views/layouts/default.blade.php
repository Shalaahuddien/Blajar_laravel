...
<head>
    ...
    <!-- <link href="{{ 'assets/css/cs-skin-elastic.css' }}"> -->
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="">
                        <a href=" #"> <i class="menu-icon fa fa-list"></i>Lihat
                        Barang</a>
                    </li>
                    <li class="">
                        <a href=" #"> <i class="menu-icon fa fa-plus"></i>Tambah
                        Barang</a>
                    </li>

                    <li class="menu-title">Foto Barang</li><!-- /.menu-title -->
                    <li class="">
                        <a href=" #"> <i class="menu-icon fa fa-list"></i>Lihat Foto
                        Barang</a>
                    </li>
                    <li class="">
                        <a href=" #"> <i class="menu-icon fa fa-plus"></i>Tambah Foto
                        Barang</a>
                    </li>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text">Rp. <span
                                                    class="count">123901212</span></div>
    ...
    <!-- untuk laravel 8 bentukan asset code seperti di bawah -->
